...
def run(date_str, t_mode):
    ...
    # FIXED: T_MODE should use code as key, not "mode"
    shared['T_MODE'] = {code: t_mode}
    ...
    for i in indices:
        ...
        t_mode_detected = ind.get("t_mode", "unknown") if ind else "unknown"
        ...
        out.append({
            ...
            "alert": alert, "dg": bool(alert_dg), "t_mode": t_mode_detected
        })
    return out

print("=" * 70)
print("07-14 华工科技 正T vs 反T 详细对比 (T_MODE修复)")
print("=" * 70)
