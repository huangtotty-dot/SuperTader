# coding=utf-8
"""
[ARCHIVED 2026-08-28] WP-B22 已废止：
  2026-08-28 owner 选择方案 C，用全局 -8% 硬止损（HARD_STOP_EXIT）替代 MA5 破位清仓，
  原 MA5 破位容差逻辑与参数 ma5_break_tolerance 已移除。
  515180 低波动 ETF 的定制需求由 WP-E4（M2 池闸/做 T 低波动参数）覆盖，
  对应回归见 test_wp_e4.py。

历史文件：tests/test_wp_b22.py — WP-B22 MA5破位容差 + 600481 M2池闸定制 验证
