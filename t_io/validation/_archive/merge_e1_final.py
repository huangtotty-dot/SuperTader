# -*- coding: utf-8 -*-
"""
merge_e1_final.py — E1 决赛档实验两组合并 + summary 重算(仿 merge_variant_a.py)
两组: T36b(引擎买阈36+notify36) / T30b(引擎买阈30+notify30), parts 内文件统一为 *_v102.*
对照基线: 复用 e2_variant_a/control 合并结果(不在此合并)。
...
FORM = {"T36b": "v1.1.1+E1_T36b(引擎买阈36+notify36对齐)",
        "T30b": "v1.1.1+E1_T30b(引擎买阈30+notify30对齐)"}
