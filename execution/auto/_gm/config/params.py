...
INDEX_REGIME_PARAMS = {
    ...
    # 2026-09-15 B7实单施工：B7 尾盘反T实单通道总开关。
    # 2026-09-15 17:23 owner 拍板：跳过影子期直接上实单。
    # 2026-09-15 翻启：L3 前置审计 2 个阻断点（B1 awaiting_buyback 污染 / B2 open_align
    # 双买）+ B4/B8 修复完毕（b54781ed），四套测试 184 项全绿，无残留挂账链 → 当日翻启，
    # 实单首日 = 2026-09-16。
